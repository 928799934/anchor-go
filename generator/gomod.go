...
func (g *Generator) gen_gomod() ([]byte, error) {
	...
	mdf.AddGoStmt(g.options.Version)

	mdf.AddNewRequire("github.com/gagliardetto/solana-go", "v1.16.0", false)
	mdf.AddNewRequire("github.com/gagliardetto/anchor-go", "v1.0.0", false)
	...
	mdf.AddNewRequire("github.com/stretchr/testify", "v1.11.1", false)
	mdf.AddNewRequire("github.com/928799934/go-spew", "v1.1.2", false)
